...
public class UserTestData {
    ...
    public static final SubscriptionResponseDto SUBSCRIPTION_RESPONSE_DTO3 = new SubscriptionResponseDto(
            3L,
            LocalDate.now(),
            LocalDate.now().plusDays(30),
            null);
    public static final UrlBindingResponseDto URL_BINDING_RESPONSE_DTO3 = new UrlBindingResponseDto(
            3L,
    ...
    public static final FullUserResponseDto FULL_USER_RESPONSE_DTO3 = new FullUserResponseDto(
            USER_RESPONSE_DTO3,
            Set.of(SUBSCRIPTION_RESPONSE_DTO3),
            Set.of(URL_BINDING_RESPONSE_DTO3)
    );
    ...
    public static final User TEST_USER3 = User.builder()
            .id(3L)
            .firstName(USER_RESPONSE_DTO3.firstName())
            .lastName(USER_RESPONSE_DTO3.lastName())
            .email(USER_RESPONSE_DTO3.email())
